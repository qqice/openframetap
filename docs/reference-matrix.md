...
| Connect Wi-Fi | App `02` -> Wi-Fi `07`, `40/07/47` | packed SSID + packed PSK | node-osmo, Moblin, and djictl agree on request packing. Public/reference response lengths conflict. | High request schema; medium response schema | Private candidate generated and offline-validated as a 45-byte frame; SHA-256 `8751117a...ed72e`. Unsent and awaiting separate B-class authorization. |
