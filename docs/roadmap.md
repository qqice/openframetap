...
4. **Current, owner-execution pending:** the LAN-only user-space RTMP receiver and local publish/readback test are complete; the independently reviewed `02/E1` prepare proposal has one-time owner authorization but has not been sent. Its response must be captured and analyzed before any separately authorized Wi-Fi proposal is considered.
