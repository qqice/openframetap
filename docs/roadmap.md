...
4. **Current, user-gated:** the LAN-only user-space RTMP receiver and local publish/readback test are complete; the independently reviewed `02/E1` prepare proposal awaits its first explicit authorization before Pocket Wi-Fi provisioning or streaming can proceed.
